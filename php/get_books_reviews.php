...
$sql = "SELECT books.id, books.title, books.author,books.cover_url,AVG(reviews.rating) as avg_rating FROM books LEFT JOIN reviews ON books.id = reviews.book_id GROUP BY books.id, books.title, books.author, books.cover_url";
